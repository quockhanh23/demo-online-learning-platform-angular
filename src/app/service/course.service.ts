...
export class CourseService {
  ...
  getAllCourseByDepartment(page: any, size: any, searchText: string, idDepartment: any): Observable<PageCourse> {
    return this.http.get<PageCourse>(API_URL +
      `/getAllCourseByDepartment?page=${page}&size=${size}&searchText=${searchText}&idDepartment=${idDepartment}`)
  }
